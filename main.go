...
func HelloKoala(w http.ResponseWriter, req *http.Request) {
	...
	if err != nil {
		fmt.Fprintln(w, "Error reading VERSION file (test-create-service-3): "+err.Error())
		return
	}
	fmt.Fprintln(w, "Hello world! service:test-create-service-3 version: "+string(VERSION))
}
